...
describe('NoiseGenerator', () => {
    it('should generate consistent noise with same seed', () => {
        ...
        const result1 = noise1.noise2D(1.5);
        const result2 = noise2.noise2D(1.5);
...
describe('BikePhysics', () => {
    ...
    it('should update gear based on speed', () => {
        ...
        bike.update(0.016, { throttle: false, brake: false, steerLeft: false, steerRight: false }, 5, new THREE.Vector3(0, 1, 0));
...
describe('TerrainSystem', () => {
    ...
    it('should create track mesh', () => {
        const terrain = new TerrainSystem(42);
        expect(() => terrain.createTrack(50, 12)).not.toThrow();
    });
});
